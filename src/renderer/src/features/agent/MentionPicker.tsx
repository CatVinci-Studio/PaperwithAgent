...
export function MentionPicker({ x, y, query, onPick, onCancel }: MentionPickerProps) {
  ...
  return (
    ...
    >
      <div className="px-3 py-1.5 text-[10.5px] uppercase tracking-wider text-[var(--text-muted)] border-b border-[var(--border-color)]">
        {collection == null
      ...
      <div className="flex-1 overflow-y-auto py-1">
        {items.length === 0 && (
          <div className="px-3 py-6 text-center text-[11.5px] text-[var(--text-muted)]">
